...
function updateResponsiveBackgrounds() {
    ...
    $(".bg-img").each(function () {
        var desktopImg = $(this).data("background-desktop");
        var mobileImg = $(this).data("background-mobile");
        var chosenImg = isMobile ? mobileImg : desktopImg;

        if (chosenImg) {
            $(this).css("background-image", "url(" + chosenImg + ")");
        }
    });
}
